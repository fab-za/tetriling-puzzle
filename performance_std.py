...
target, perfect_solution = utils.generate_target(width=40, height=30, density=0.7, forbidden_pieces=the_forbidden_pieces) # NOTE: it is recommended to keep density below 0.8
